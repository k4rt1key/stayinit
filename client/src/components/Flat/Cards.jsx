...
export default function Cards({ flats }) {
    ...
    function submitFilters(event) {
        ...
        if (filters.furnitureType) searchParams.set("furnitureType", filters.furnitureType);
                ...
                >
                    <div className="flex justify-center bg-colorY items-center mb-2 px-[2rem] md:px-[6rem] rounded-[1rem]">
                        <div className="flex flex-wrap justify-center items-center gap-2 my-3 py-[0.5rem] w-full" >
                            ...
                            {/* BHK Filters */}
                            <select
                                className={filterStyleForFurniture + " cursor-pointer text-[#073937] bg-colorY2"}
                                name="bhk"
                                id="bhk"
                                onChange={(event) => setFilters({ ...filters, bhk: event.target.value })}
                                value={filters.bhk}
                            >
                            ...
                            <select
                                ...
                                name="furnitureType"
                                id="furniture"
                                onChange={(event) => setFilters({ ...filters, furnitureType: event.target.value })}
                            ...
                            <input
                                ...
                                name="minSqft"
                                id="minSqft"
                                onChange={(event) => setFilters({ ...filters, minSqft: event.target.value })}
                            ...
                            <input
                                ...
                                name="maxSqft"
                                id="maxSqft"
                                onChange={(event) => setFilters({ ...filters, maxSqft: event.target.value })}
